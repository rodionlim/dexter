...
class ContextManager:
    ...
    def __init__(self, context_dir: str = ".dexter/context"):
        ...
        # Check for auto-clean environment variable
        if os.getenv("AUTO_CLEAN_CONTEXT_ON_STARTUP", "false").lower() == "true":
    ...
    def _generate_summary(self, tool_name: str, args: dict, result: Any) -> str:
        ...
        with trace(name="generate_summary"):
            ...
            Generate a brief one to two sentence summary describing what data this tool output contains.
    ...
    def save_context(
        self, tool_name: str, args: dict, result: Any, task_id: Optional[int] = None
    ) -> str:
        """
    ...
    def select_relevant_contexts(
        self, query: str, available_pointers: List[Dict[str, Any]]
    ) -> List[str]:
        """
