...
from dexter.model import get_chat_model
...
class CorrectnessScore(BaseModel):
    ...
    reasoning: str = Field(
        description="The reason for the score, including specific examples comparing the agent's answer to the reference answer."
    )
    score: int = Field(
        description="Integer score 1-5 showing how well the agent's answer matches the reference answer in terms of correctness (1 = largely incorrect, 5 = all key facts correct)."
    )
